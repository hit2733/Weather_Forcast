...
const MainPart = () => {
  ...
  const divStyle = {
    backgroundImage: 'url("https://unsplash.com/photos/blue-sky-G-6kwVnClsE")',
    backgroundSize: "cover",
  };

  const weeklyUpdates = weeklyData.map((ele, index) => {
    return (
      <div key={index} className={styles.smallCards} style={divStyle}>
                      ...
                      <div className={styles.minorInfo}>
                        {data.currentConditions && (
                          <>
                            ...
                            <div
                              style={{ marginTop: "-1em", fontWeight: "400" }}
                            >
                  ...
                  <div className={styles.highlight}>
                    ...
                    <div className={styles.Card}>
                      ...
                      <img
                        ...
                        width="80px"
                        height="0px"
                        style={{ marginRight: "-0.3em", marginTop: "0em" }}
                      />
                    </div>
                  </div>
